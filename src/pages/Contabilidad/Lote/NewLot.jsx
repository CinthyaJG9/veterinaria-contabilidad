...
const NewLot = () => {
  ...
  const onSubmit = async (event) => {
    const data = { ...event, montoTotal_lot: event.cantidadProducto_lot * event.precioUnitario_lot };
    console.log(data);
    try {
      ...
      <div className='rounded-3xl border-4 border-dashed border-[#6ED4A5] p-10'>
        ...
        >
          ...
          <div className='p-2'>
            <select
              type='text'
              className='rounded-lg border-2 border-[#44403c] max-w-fit'
            ...
            {errors.codigo_proveedor?.type === 'pattern' && <p>Solo se aceptan numeros</p>}
          </div>
          ...
          <div className='p-2'>
            ...
            {errors.codigo_producto?.type === 'pattern' && <p>Solo se aceptan numeros</p>}
          </div>
          ...
          <div className='p-2'>
            <input
              type='text'
              className='rounded-lg border-2 border-[#44403c]'
              {...register('cantidadProducto_lot', { required: true, pattern: /^[0-9]+$/i })}
            />
            {errors.codigo_producto?.type === 'pattern' && <p>Solo se aceptan numeros</p>}
          </div>
          ...
          <div className='p-2'>
            <input
              type='text'
              className='rounded-lg border-2 border-[#44403c]'
              {...register('precioUnitario_lot', { required: true, pattern: /^[0-9]+$/i })}
            />
                ...
                periodos && periodos.map(periodo => {
                  ...
                  return (
                    <option key={periodo.id_per} value={periodo.id_per}>
                      {`Inicio: ${fechaIncio.getDate()}/${fechaIncio.getMonth() + 1}/${fechaIncio.getFullYear()}, Termino: ${fechaTermino.getDate()}/${fechaTermino.getMonth() + 1}/${fechaTermino.getFullYear()}`}
                    </option>
                  )
                })
              }
          ...
          <div className='pt-8'>
            <button className='rounded-2xl bg-[#6ED4A5] p-3 px-4 font-medium' type='submit'>
              Registrar Lote
            </button>
          </div>
