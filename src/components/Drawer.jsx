...
const listItems = [
  ...
  {
    label: 'Dashboard',
    icon: <GiPieChart className='text-2xl' />,
    path: '/' // o el path que corresponda
  },
  // {
...
const Drawer = () => {
  return (
    <div className='w-2/12 h-full pt-20 pl-5 pb-5'>
      <div className='fixed border-r-2 h-full rounded-sm border-green'>
        <h5 className='px-3 font-semibold uppercase text-green text-2xl'>
          ¡Bienvenido!
        </h5>
        {/* imagen de un usuario y genernte debajo */}
        <div className='flex flex-col items-start px-2 py-2 text-green'>
        ...
        <div className='py-4 overflow-y-auto'>
          {listItems.map((item, index) => (
            <div
              key={index}
              className='flex items-center px-1 py-2 text-green hover:bg-green hover:text-white cursor-pointer'
            >
